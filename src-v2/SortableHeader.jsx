...
function SortableHeader({
  ...
  // just the full column title — shown only when the label is truncated.
  // Native `title` attrs are intentionally absent so the OS tooltip never
  // doubles up with the styled one.
  return (
