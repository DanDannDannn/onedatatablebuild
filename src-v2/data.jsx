...
window.applyDataset = function (ds) {
  ...
  const demoSpecs = [
    { id: "draft-2f9c", entry_status: "draft", category: "purchased_goods", site: "Vienna HQ",
      ...
      date: "2026-06-22", start: "2026-04-01", end: "2026-06-30", s3cat: "3.1 Purchased goods and services",
    ...
    { id: "ready-7b1a", entry_status: "ready", category: "business_travel", site: "Munich Office",
      ...
      date: "2026-06-20", start: "2026-05-01", end: "2026-05-31", s3cat: "3.6 Business travel",
    ...
    { id: "review-4e8d", entry_status: "confirmed", category: "capital_goods", site: "Linz Plant",
      ...
      date: "2026-06-18", start: "2026-06-01", end: "2026-06-15", s3cat: "3.2 Capital goods",
    ...
    { id: "review-9c2f", entry_status: "confirmed", category: "upstream_transport", site: "Rotterdam DC",
      ...
      date: "2026-06-17", start: "2026-06-01", end: "2026-06-16", s3cat: "3.4 Upstream transportation and distribution",
    ...
    { id: "sub-1a6b", entry_status: "confirmed", category: "purchased_goods", site: "Vienna HQ",
      ...
      date: "2026-06-15", start: "2026-01-01", end: "2026-03-31", s3cat: "3.1 Purchased goods and services",
  ...
  demoSpecs.unshift(
    ...
    },
    {
      ...
      date: "2026-06-24", start: "2026-01-01", end: "2026-03-31", s3cat: "3.2 Capital goods",
    ...
    },
    {
      ...
      date: "2026-06-23", start: "2026-01-01", end: "2026-03-31", s3cat: "3.1 Purchased goods and services",
    ...
    },
    {
      ...
      date: "2026-06-21", start: "2026-04-01", end: "2026-06-30", s3cat: "3.4 Upstream transportation and distribution",
    ...
    },
    {
      ...
      date: "2026-06-19", start: "2026-04-01", end: "2026-06-30", s3cat: "3.1 Purchased goods and services",
  ...
  demoSpecs.unshift(
    ...
    //     EF name Multiple · LCA Multiple · CO2e summed (1,706.78).
    {
      ...
      date: "2026-07-01", start: "2026-01-01", end: "2026-01-31", s3cat: "3.7 Employee commuting",
      ef_selection: "Auto-selected",
