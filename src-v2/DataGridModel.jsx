...
const DATA_COLUMNS = [
  ...
  { k:"ef_unit",           label:"Emission factor unit",     w:150, kind:"calc", ro:true, group:"ef" },
  { k:"ef_source",         label:"Emission factor source",   w:160, kind:"calc", ro:true, group:"ef" },
  { k:"ef_dataset",        label:"Emission factor dataset",  w:170, kind:"calc", ro:true, group:"ef" },
  { k:"ef_year",           label:"Emission factor year",     w:130, kind:"calc", ro:true, group:"ef" },
  { k:"ef_region",         label:"Emission factor region",   w:150, kind:"calc", ro:true, group:"ef" },
  { k:"ef_lca",            label:"Emission factor LCA activity", w:190, kind:"calc", ro:true, group:"ef" },
  // Other hidden detail
  { k:"co2e_method",       label:"CO\u2082e calculation method", w:200, kind:"calc",  ro:true },
  { k:"scope2_method",     label:"Scope 2 method",           w:160, kind:"calc",  ro:true },
  { k:"scope3_category",   label:"Scope 3 category",         w:190, kind:"calc",  ro:true },
  { k:"custom_factor",     label:"Custom Emission Factor",   w:180, kind:"entry" },
