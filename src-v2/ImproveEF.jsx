// Improve EF · synthetic PCF — SCCF-side mock, product-style (#improve-ef).
//
// Single design (the former "option 2", now also carrying the detail-page
// CTA): a "EF confidence" COLUMN next to the EF name carries the low-match
// signal (Low / Med / High pills); the "Improve EF" CTA appears both inline
// on row hover (right-frozen actions cell) and in the entry-detail modal
// (top banner + sticky footer). The workflow status stays "Submitted"
// throughout — progress shows as an extra "Improving EF…" chip.
...
// Flow: CTA → AI wizard hand-off dialog → "Improving EF…", the Calculation
// section on the detail modal is replaced by a progress panel → after a few
// seconds the improved synthetic EF lands: special name + "Synthetic EF"
// flag, confidence high again.
...
function IefDetailModal({ entry, phase, onClose, onImprove }) {
  React.useEffect(() => {
        ...
        <table className="ief-table">
          <thead>
            <tr>
              ...
              <th className="new-col">EF confidence</th>
